...
Route::post('/input-masukan', 'FrontendController@inputmasukan');
Route::post('/cari-warga', 'FrontendController@cariwarga');
...
Route::group(['middleware' => ['superadmin']], function ()
{
    ...
    Route::post('/penduduk/list/uploadfoto', 'PendudukController@uploadfoto');

    //crud Kelompok
    Route::get('/penduduk/kelompok', 'KelompokController@index');

    //crud pemerintah
    Route::get('/rt/pemerintah', 'PemerintahController@index');
    Route::get('/rt/pemerintah/create', 'PemerintahController@create');
    Route::post('/rt/pemerintah/create', 'PemerintahController@store');
    Route::get('/rt/pemerintah/edit/{id}', 'PemerintahController@edit');
    Route::put('/rt/pemerintah/edit/{id}', 'PemerintahController@update');

    Route::get('/rt/identitas', 'RtController@index');
    Route::post('/rt/identitas', 'RtController@storeorupdate');
